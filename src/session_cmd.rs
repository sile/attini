//! Top-level session inspection subcommands (status / ask).
...
use crate::session::{
    ConversationSummary, LockStatus, PendingSummary, SessionPaths, inspect_lock,
    read_pending_summary, scan_conversation, session_paths,
};
use crate::tell_cli;
